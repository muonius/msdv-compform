...
pane.addInput(params, "redNoiseEnd", { min: 0, max: 1, step: 0.01 });
...
pane.addInput(params, "greenNoiseEnd", { min: 0, max: 1, step: 0.01 });
...
pane.addInput(params, "blueNoiseEnd", { min: 0, max: 1, step: 0.01 });

...
function setup() {
    ...
    createP("OperationsX")
    opSliderX = createSlider(0, 3, 0)

    createP("OperationsY")
    opSliderY = createSlider(0, 3, 0)

    // createP("scale")
    // scaleSlider = createSlider(10, 40, 10)

    createP("Multiplier a1")
    a1Slider = createSlider(1, 10, 0.1)

    createP("Multiplier a2")
    a2Slider = createSlider(1, 10, 0.1)
...
function draw() {
    ...
    for (let a = 0; a < 360; a += radians(1)) {
        ...
        if (opSliderX.value() == 3) {
            x1 = r * 10 * sin(a + r) * sin(a * a2Slider.value() + r * a2Slider.value()) * (a * sin(a * a2Slider.value() * r * a3Slider.value()))
        } else if (opSliderX.value() == 1) {
            x1 = r * 10 * sin(a + r) * sin(a * a2Slider.value() + r * a2Slider.value()) + (a + sin(a * a2Slider.value() * r * a3Slider.value()))
        }
        else if (opSliderX.value() == 2) {
            x1 = r * 10 * sin(a + r) * sin(a * a2Slider.value() + r * a2Slider.value()) - (a * sin(a * a2Slider.value() * r * a3Slider.value()))
        }

        else if (opSliderX.value() == 0) {
        ...
        if (opSliderY.value() == 3) {
            y1 = -r * (13 * cos(a * a1Slider.value() + r * a1Slider.value()) + 15 * cos(2 * a2Slider.value() - r * a2Slider.value()) - 7 * cos(3 * a3Slider.value() + r * a3Slider.value()) * cos(4 * a2Slider.value()));
        } else if (opSliderY.value() == 1) {
            y1 = r * (13 * cos(a * a1Slider.value() + r * a1Slider.value()) * cos(3 * a2Slider.value() * r * a3Slider.value()) * cos(4 * a2Slider.value()));

        }
        else if (opSliderY.value() == 2) {
            y1 = -r * (13 * cos(a * a1Slider.value() + r * a1Slider.value()) + cos(7 * a2Slider.value() * r * a3Slider.value()) * cos(4 * a2Slider.value()));
        }

        else if (opSliderY.value() == 0) {
            y1 = -r * (13 * cos(a * a1Slider.value() + r * a1Slider.value()) + 9 * cos(2 * a2Slider.value() + r * a2Slider.value()) - 12 * cos(3 * a3Slider.value() + r * a3Slider.value()) * cos(4 * a2Slider.value()));
        }
